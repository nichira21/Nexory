...
})(window,document,'script','dataLayer','GTM-5FZFH9RB');</script>
<!-- End Google Tag Manager -->
  ...
  <!-- Meta Pixel Code -->
    ...
    src="https://www.facebook.com/tr?id=918300190624192&ev=PageView&noscript=1"
    /></noscript>
  <!-- End Meta Pixel Code -->
...
.ux-backdrop {
  ...
  z-index: 1045; /* di bawah offcanvas (1046) */
  opacity: 0;
...
.logo-crop {
    height: 300px;          /* tinggi hasil akhir */
    overflow: hidden;       /* POTONG atas & bawah */
