...
<div class="container py-2">
  <div class="row">
    <div class="ms-3">
      <h3 class="mb-0 h4 font-weight-bolder"> <?= $judul_pendek; ?></h3>
      <p class="mb-4">
        <?= $deskripsi; ?>
      </p>
    </div>
      ...
      <div class="card">
        <div class="card-header p-2 ps-3">
          <div class="d-flex justify-content-between">
            <div>
              <p class="text-sm mb-0 text-capitalize">Total Saldo</p>
              <h4 class="mb-0">Rp 1.002.254</h4>
            </div>
    ...
    <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
      <div class="card">
        <div class="card-header p-2 ps-3">
          <div class="d-flex justify-content-between">
            <div>
              <p class="text-sm mb-0 text-capitalize">Total Pesanan Pending</p>
              <h4 class="mb-0">18</h4>
            </div>
            <div class="icon icon-md icon-shape bg-gradient-dark shadow-dark shadow text-center border-radius-lg">
    ...
    <div class="col-xl-3 col-sm-6">
      <div class="card">
        <div class="card-header p-2 ps-3">
          <div class="d-flex justify-content-between">
            <div>
              <p class="text-sm mb-0 text-capitalize">Persentase KPI</p>
              <h4 class="mb-0">58%</h4>
            </div>
            <div class="icon icon-md icon-shape bg-gradient-dark shadow-dark shadow text-center border-radius-lg">
              <i class="material-symbols-rounded opacity-10">weekend</i>
  ...
  <div class="row">
    <div class="col-lg-4 col-md-6 mt-4 mb-4">
      <div class="card">
        <div class="card-body">
          <h6 class="mb-0 ">View Marketplace</h6>
          <div class="pe-2">
            <div class="chart">
    ...
    <div class="col-lg-4 col-md-6 mt-4 mb-4">
      <div class="card ">
        <div class="card-body">
          <h6 class="mb-0 "> Penjualan Marketplace </h6>
          <div class="pe-2">
            <div class="chart">
    ...
    <div class="col-lg-4 mt-4 mb-3">
      <div class="card">
        <div class="card-body">
          <h6 class="mb-0 ">Produk Tercipta</h6>
          <div class="pe-2">
            <div class="chart">
